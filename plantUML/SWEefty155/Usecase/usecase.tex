...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.2}{UC1.2}: Visualizzazione informazioni componenti}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.2.1}{UC1.2.1}: Visualizzazione del nome identificativo dei componenti}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.2.2}{UC1.2.2}: Visualizzazione del linguaggio di implementazione dei server}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.3}{UC1.3}: Visualizzazione degli insiemi di richieste fra componenti}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.3.1}{UC1.3.1}: Visualizzazione in base al tipo di richiesta}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.3.2}{UC1.3.2}: Colorazione degli archi corrispondenti a tempi di risposta}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.3.3}{UC1.3.3}: Visualizzazione delle richieste HTTP}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.3.4}{UC1.3.4}: Visualizzazione delle richieste ai database}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.3.5}{UC1.3.5}: Colorazione degli archi corrispondenti a tempi di risposta critici}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.3.6}{UC1.3.6}: Colorazione degli archi corrispondenti a tempi di risposta regolari}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2}{UC2}: Riposizionamento componenti della mappa topologica}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2.1}{UC2.1}: Riposizionamento componente}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2.2}{UC2.2}: Riposizionamento automatico componenti}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3}{UC3}: Ridimensionamento della mappa topologica}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3.1}{UC3.1}: Ingrandimento della mappa topologica}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3.2}{UC3.2}: Restringimento della mappa}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3.3}{UC3.3}: Visualizzazione mappa a schermo intero}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC5}{UC5}: Visualizzazione stack trace}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC5.1}{UC5.1}: Visualizzazione dettagli singola trace}
\begin{figure} [H]
\centering
\includegraphics[scale=0.45]{./UC5-1.png}
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC5.1.1}{UC5.1.1}: Visualizzazione numerazione delle trace}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC5.1.2}{UC5.1.2}: Visualizzazione identificativo delle trace tramite richiesta HTTP}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC5.1.3}{UC5.1.3}: Visualizzazione momento di esecuzione delle trace}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC5.1.4}{UC5.1.4}: Visualizzazione tempo di esecuzione delle trace}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC5.1.5}{UC5.1.5}: Visualizzazione codice di stato HTTP di ogni trace}
\begin{figure} [H]
\centering
\includegraphics[scale=0.45]{./UC5-1-5.png}
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC5.1.5.1}{UC5.1.5.1}: Visualizzazione dettaglio errore}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6}{UC6}: Riordinamento della stack trace}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6.1}{UC6.1}: Riordinamento dello stack trace in ordine crescente}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6.2}{UC6.2}: Riordinamento dello stack trace per ordine decrescente}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC7}{UC7}: Riordinamento stack trace per momento di inizio dell'esecuzione}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC8}{UC8}: Riordinamento stack trace per tempo di esecuzione}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC9}{UC9}: Fallimento caricamento dati della stack trace}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10}{UC10}: Visualizzazione call tree}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.1}{UC10.1}: Visualizzazione dettagli singolo metodo}
\begin{figure} [H]
\centering
\includegraphics[scale=0.45]{./UC10-1.png}
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.1.1}{UC10.1.1}: Visualizzazione nome metodo}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.1.2}{UC10.1.2}: Visualizzazione self execution time}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.1.3}{UC10.1.3}: Visualizzazione total execution time}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.1.4}{UC10.1.4}: Visualizzazione query di ogni metodo}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC11}{UC11}: Cambio organizzazione della visualizzazione di un metodo del call tree}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC11.1}{UC11.1}: Collasso sottochiamate}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC11.2}{UC11.2}: Visualizzazione sottochiamate nascoste}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC12}{UC12}: Visualizzazione elenco delle query di una singola trace}
\begin{figure} [H]
\centering
\includegraphics[scale=0.45]{./UC12.png}
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC12.1}{UC12.1}: Visualizzazione dettagli di una singola query}
\begin{figure} [H]
\centering
\includegraphics[scale=0.45]{./UC12-1.png}
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC12.1.1}{UC12.1.1}: Visualizzazione numerazione di ogni query}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC12.1.2}{UC12.1.2}: Visualizzazione testo di ogni query}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC12.1.3}{UC12.1.3}: Visualizzazione identificativo database interrogato}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC12.1.4}{UC12.1.4}: Visualizzazione momento di esecuzione di ogni query}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC12.1.5}{UC12.1.5}: Visualizzazione tempo di esecuzione di ogni query}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC13}{UC13}: Riordinamento delle query di una singola trace}
\begin{figure} [H]
\centering
\includegraphics[scale=0.45]{./UC13.png}
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC13.1}{UC13.1}: Riordinamento delle query per ordine crescente}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC13.2}{UC13.2}: Riordinamento delle query per ordine decrescente}
\begin{itemize}
\item \textbf{Attori}: Utente
